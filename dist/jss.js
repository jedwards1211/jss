...
/***/ function(module, exports, __webpack_require__) {
	...
	var sheets = new _SheetsRegistry2['default']();
	/**
	 * Main Jss class.
	 *
	 * @api public
...
/***/ function(module, exports, __webpack_require__) {
	...
	var atRuleNameRegExp = new RegExp('^' + Object.keys(atRuleClassMap).join('|'));
	...
	function createRule(selector) {
	  ...
	  if (selector && selector[0] === '@') {
	    var result = atRuleNameRegExp.exec(selector);
	    if (result) RuleClass = atRuleClassMap[result[0]];else (0, _warning2['default'])(false, '[JSS] Unknown at-rule %s', selector);
	  }
